	...
	public static void main(String[] args) {
		try {
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Nature-Inspired</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Nature-Inspired.<br>"
					...
					+ "<br>We are providing upto 20% OFF on most of the electronic gadgets. So please visit our site and explore the collections. <br>"
					+ " <br>Our Online Flower shop is growing in a larger amount these days and we are in high demand so we thanks all of you for "
